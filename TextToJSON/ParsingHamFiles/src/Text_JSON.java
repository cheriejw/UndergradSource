...
public class Text_JSON {
	...
	public static void main(String[]args) throws IOException{
		runFile("D:\\Workspaces\\CECS429\\JSONPARSE\\ParsingHamFiles\\src\\MADISON");
		runFile("D:\\Workspaces\\CECS429\\JSONPARSE\\ParsingHamFiles\\src\\HAMILTON");
		runFile("D:\\Workspaces\\CECS429\\JSONPARSE\\ParsingHamFiles\\src\\HAMILTON AND MADISON");
		runFile("D:\\Workspaces\\CECS429\\JSONPARSE\\ParsingHamFiles\\src\\HAMILTON OR MADISON");
		runFile("D:\\Workspaces\\CECS429\\JSONPARSE\\ParsingHamFiles\\src\\JAY");
	}
	/**
	 ...
	 * @throws IOException
	 */
	public static void runFile(String pathDir) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public static JSONobject getJObj(Path pathDir) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public static String getTitle(Path pathDir) throws IOException{
	 ...
	 * @throws IOException 
	 */
	public static String getBody(Path pathDir) throws IOException{
		BufferedReader br = new BufferedReader(new FileReader(pathDir.toString()));
		String line, body;
		int count = 0;
		try {
	 ...
	 * @return
	 */
	public static String getAuthor(Path pathDir){
	 ...
	 * @param jobj
	 */
	public static void writeJSON(Path pathTxt, JSONobject jobj){
		Writer writer = null;
		Gson gson = new Gson();
